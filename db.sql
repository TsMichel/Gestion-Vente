...
-- Insérer des données initiales dans la table produits
...
-- Insérer des données initiales dans la table clients
...
-- Insérer des données initiales dans la table ventes
